...
public class SkuInfo {
    ...
    public List<Crates> getCrates() { return crates; }

    public String getPicking_timestamp() { return picking_timestamp; }

    public void setPicking_timestamp(String picking_timestamp) { this.picking_timestamp = picking_timestamp; }
    ...
    private String picking_timestamp;
}
